			...
			<div class="row">
				...
				<div class="col-md-7">
					<div class="form-group" style="float: right;">
						...
						<button data-toggle="modal" data-target="#findtop" id="find" class="btn btn-sm btn-dark mb-1 mt-1 mr-1 ml-1" style="margin-bottom: 0px;"><i class="far fa-file-search" style="margin-right: 10px;"></i>Find</button>
					...
					<div class="row mb-2 mt-2">
						<div class="col-sm-12 input-group">
							<div class="col-sm-3 p-0 input-group-prepend">
								<span class="col-sm-12 input-group-text">Kode TOP</span>
							</div>
							<input class="col-sm-3 form-control" type="text" name="kode" id="kode" maxlength="50" placeholder="Kode TOP" required readonly/>
						</div>
					</div>
					<div class="row mb-2">
						<div class="col-sm-6 input-group box">
							<div class="col-sm-6 p-0 input-group-prepend">
								<span class="col-sm-12 input-group-text">Jumlah Hari</span>
							</div>
							<input class="form-control" type="number" name="jumlah" id="jumlah" maxlength="50" placeholder="Jumlah Hari" required />
						</div>
						<div class="col-sm-6 input-group">
							<div class="col-sm-6 p-0 input-group-prepend">
								<span class="col-sm-12 input-group-text">Kota</span>
							</div>
							<input class="col-sm-12 form-control" type="text" name="kota" id="kota" maxlength="50" placeholder="Kota" required />
						</div>
					</div>
					<div class="row mb-2">
						<div class="col-sm-12 input-group box">
							...
							<input class="form-control" type="text" name="keterangan" id="keterangan" maxlength="50" placeholder="Keterangan" required />
						</div>
					</div>
...
<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="findtop">
	<div class="modal-dialog modal-lg">
		<div class="modal-content" style="border-radius: 5px;">
			<div class="modal-header" style="padding: 10px; color: #000;">
				<h7 class="modal-title" style="margin-left: 5px;">Data Term of Payment</h7>
			...
			<div class="modal-body">
				<div class="table-responsive">
					<table id="t_top" class="table table-bordered table-striped dt-responsive display nowrap" style="width:100%">
						<thead class="thead-dark">
							<tr>
								<th width="10">Action</th>
								<th width="150">Kode TOP</th>
								<th width="150">Nama TOP</th>
								<th width="150">Jumlah Hari</th>

			...
			<div class="row">
				...
				<div class="col-md-7">
					<div class="form-group" style="float: right;">
						...
						<button data-toggle="modal" data-target="#findsatuan" id="find" class="btn btn-sm btn-dark mb-1 mt-1 mr-1 ml-1" style="margin-bottom: 0px;"><i class="far fa-file-search" style="margin-right: 10px;"></i>Find</button>
				...
				<div class="modal-body">
					...
					<div class="row mb-2">
						<div class="col-sm-12 input-group box">
							<div class="col-sm-3 p-0 input-group-prepend">
								<span class="col-sm-12 input-group-text">Nama Satuan</span>
							</div>

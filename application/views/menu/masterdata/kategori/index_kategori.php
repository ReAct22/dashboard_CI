			...
			<div class="row">
				...
				<div class="col-md-7">
					<div class="form-group" style="float: right;">
						...
						<button data-toggle="modal" data-target="#findkategori" id="find" class="btn btn-sm btn-dark mb-1 mt-1 mr-1 ml-1" style="margin-bottom: 0px;"><i class="far fa-file-search" style="margin-right: 10px;"></i>Find</button>
				...
				<div class="modal-body">
					<div class="row mb-2 mt-2">
						<div class="col-sm-12 input-group">
							...
							<input class="col-sm-3 form-control" type="text" name="kodekg" id="kode" maxlength="50" placeholder="Kode Kategori" required />
						</div>
					</div>
					<div class="row mb-2">
						<div class="col-sm-12 input-group box">
							<div class="col-sm-3 p-0 input-group-prepend">
								<span class="col-sm-12 input-group-text">Nama Kategori</span>
							</div>
							<input class="form-control" type="text" name="namakg" id="nama" maxlength="50" placeholder="Nama Kategori" required />
						</div>
					</div>
